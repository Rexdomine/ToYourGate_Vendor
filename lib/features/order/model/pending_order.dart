...
class PendingOrderModel {
    ...
    factory PendingOrderModel.fromJson(Map<String, dynamic> json) => PendingOrderModel(
        data: json["data"] == null ? [] : List<PendingOrderDatum>.from(json["data"]!.map((x) => PendingOrderDatum.fromJson(x))),
    );
...
class PendingOrderDatum {
    ...
    factory PendingOrderDatum.fromJson(Map<String, dynamic> json) => PendingOrderDatum(
        id: json["id"],
        userId: json["user_id"],
